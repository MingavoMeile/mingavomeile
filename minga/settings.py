"""
Django settings for minga project.
"""
...
ALLOWED_HOSTS = ['myminga.minga.ch','minga.juntagrico.science', 'localhost',]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','minga.db'), 
...
WSGI_APPLICATION = 'minga.wsgi.application'
...
"""
     juntagrico Settings
"""
ORGANISATION_NAME = "Genossenschaft Minga vo Meile"
ORGANISATION_LONG_NAME = "Genossenschaft Minga vo Meile"
ORGANISATION_ADDRESS = {"name":"Genossenschaft Minga vo Meile", 
            "street" : "Bergstrasse",
            "number" : "133",
            "zip" : "8706",
            "city" : "Meilen",
